...
@push('page-header')
<div class="col-sm-12">
	<h3 class="page-title">Produits expirés</h3>
	<ul class="breadcrumb">
		<li class="breadcrumb-item"><a href="{{route('products')}}">Produits</a></li>
		<li class="breadcrumb-item active">Produits expirés</li>
	</ul>
</div>
@endpush
					...
					<table id="datatable-export" class="table table-striped table-bordered table-hover table-center mb-0">
						...
						<tbody>
							...
							<tr>
								...
								<td><span class="btn btn-sm bg-danger-light">PRODUIT EXPIRÉ</span></td>
								<td>
									<div class="actions">
